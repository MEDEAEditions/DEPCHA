...
COMPTES.TITRE as bk_name_from,
-- COMPTES.TITRE as bk_name_to,
ECRITURES.ID_COMPTE_CREDITEUR as bk_from,
ECRITURES.ID_COMPTE_DEBITEUR as bk_to,
...
ECRITURES.VALEUR1 as bk_money1, ECRITURES.VALEUR2 as bk_money2, ECRITURES.VALEUR3 as bk_money3,  
ECRITURES.QUANTITE1, ECRITURES.QUANTITE2,  ECRITURES.QUANTITE3,  ECRITURES.QUANTITE4,
TYPE_UNITE.ID as bk_unit,
ECRITURES.OBJET_ECRITURE_ID, ECRITURES.OBJET_ECRITURE_ID2, OBJET_ECRITURE.LIBELLE as object_, 
PRODUITS.LIBELLE as bk_commodity,
TYPE_PRODUIT.LIBELLE as bk_commodityTaxonomy
...
-- because all entries with NIVEAU contain the sum of multiple VALEUR (values)
WHERE NIVEAU = 1
...
call CSVWRITE ( 'C:/MyFolder/magprof.csv', 'SELECT
ECRITURES.DATE_ECR as bk_when, 
ECRITURES.DESCRIPTION as bk_entry, 
ACTEURS.ACTEUR_ID as bk_betweenID, 
COMPTES.TITRE as bk_name_from,
