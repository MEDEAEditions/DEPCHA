        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div id="bubble_commodity">
                        <script src="https://d3js.org/d3.v4.js"><xsl:text> </xsl:text></script>
                    <script>
                        var data = [{
 "name": "flare",
 "children": [
  ...
  },
  {
   ...
   "children": [
    ...
    {"name": "Visualization", "size": 16540}
                        ...
                        var svg = d3.select("#bubble_commodity").append("svg")
                        .attr("width", diameter)
                   ...
                   <xsl:text> </xsl:text>
                    ...
                    <h3>List</h3>
                    <ul>
                        <xsl:for-each select="//s:results/s:result/s:Commodity">
                            <li>
                                <xsl:value-of select="."/>
                            </li>
                        </xsl:for-each>
